...
export default function CalendarPage() {
  ...
  return (
    <div className="calendar-page p-8 bg-gray-50 min-h-screen">
      ...
      <div className="section-classes mb-10">
        <h2 className="text-2xl font-semibold border-b-2 border-red-500 mb-4 pb-2">
        ...
        {classesForSelectedDate.length > 0 ? (
          <ul className="space-y-4">
            {classesForSelectedDate.map((classInfo) => (
              <li
                key={classInfo.id}
                className="p-4 bg-red-400 rounded-lg shadow-md hover:bg-red-500 transition-all"
              >
      ...
      <div className="section-assignments mb-10">
        <h2 className="text-2xl font-semibold border-b-2 border-green-500 mb-4 pb-2">
        ...
        {assignmentsForSelectedDate.length > 0 ? (
          <ul className="space-y-4">
            {assignmentsForSelectedDate.map((assignment) => (
              <li
                key={assignment.id}
                className="p-4 bg-green-400 rounded-lg shadow-md hover:bg-green-500 transition-all"
              >
                <h3 className="text-lg font-bold mb-2 text-white">
